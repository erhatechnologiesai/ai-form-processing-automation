# AI Form Processing & Audit Automation
...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/erhatechnologiesai/ai-form-processing-automation.git
   cd ai-form-processing-automation
   ```
